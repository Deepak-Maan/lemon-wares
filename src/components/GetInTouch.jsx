    ...
    <div className="overflow-hidden " id='contact'>
      <div className='max-w-[1220px] mx-auto px-3 bg-[#F7FAFE] rounded-2xl relative'>
        ...
        <div className='   px-5 sm:px-12 lg:pl-[118px] lg:pr-[90px]'>
          ...
          <div className="flex justify-center pt-10 pb-5 md:pb-10 lg:pb-[88px] font-poppins leading-6 text-sm font-normal"><a href="whatsapp://send?phone=+919034394727" className='py-3 px-4 text-white bg-[#B00000] flex rounded-lg'><Whatsapp /> Get  in touch with us</a></div>
        </div>
      </div>
    </div>
  )
