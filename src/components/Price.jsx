...
const Price = () => {
    ...
    return (
        <div className=" max-w-[1200px] px-3 mx-auto pt-32 ">
            <h2 className=" text-[50px] font-semibold leading-[60px] text-center text-black max-w-[650px] mx-auto font-poppins">Ready to get started with Lemon Wares?</h2>
            <p className=" text-[25px] font-normal leading-[25px] font-poppins text-center text-black pt-9">Choose the package that suits you</p>
            <div className=" flex justify-center gap-4 md:gap-8 items-center pt-14">
                <p className="text-[25px] font-normal leading-[25px] font-poppins text-black">Monthly</p>
                <span className="flex w-[93px] h-[50px] rounded-full bg-[#B00000] sm:ml-8 sm:mr-7 relative  items-center cursor-pointer">
                    <span className="flex w-[30px] h-[30px] bg-white rounded-full absolute left-2"></span>
                </span>
                <p className="text-[25px] font-normal leading-[25px] font-poppins text-black">Yearly</p>
            ...
            <div className=" flex justify-center  relative pt-20 max-w-[856px] mx-auto w-full">
                ...
                <div className={`${data === "tab1" && "  relative before:h-[2px] before:rounded-[10px] before:bg-[#B00000] before:absolute before:bottom-[-10%] before:w-full before:left-0  "}  flex w-1/2 justify-center`}>
                    <p onClick={() => tabs('tab1')} className={` text-[30px] cursor-pointer font-semibold leading-10 font-poppins text-black`}> Basic </p>
                </div>
                <div className={`${data === "tab2" && "  relative before:h-[2px] before:rounded-[10px] before:bg-[#B00000] before:absolute before:bottom-[-10%] before:w-full before:left-0 "}  flex w-1/2 justify-center`}>
                    <p onClick={() => tabs('tab2')} className={` text-[30px] cursor-pointer font-semibold leading-10 font-poppins text-black`}> Premium  </p>
                </div>
            </div>
